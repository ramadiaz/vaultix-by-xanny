...
type MobileShellProps = {
  ...
  activeTab: MobileTab;
  children: ReactNode;
  /** Optional action element shown in desktop top bar (replaces fixed bottom button) */
  ...
  return (
    <>
      ...
      <div className="hidden lg:block">
        <DesktopShell title={title} activeTab={activeTab} action={desktopAction}>
          {children}
        </DesktopShell>
      </div>

      {/* ── Mobile layout (<1024px) ── */}
      <div className="flex min-h-dvh flex-col bg-background lg:hidden">
